...
| UT-005 | Unit | Authentication | Ensure Supabase Auth hashes passwords securely | Supabase Auth active | Plaintext password: "SecurePass123" | Returns bcrypt hash string ($2a$/$2b$), not plain text | Returns standard 60-char bcrypt hash string | Pass | 2026-07-17 | Bcrypt hashing verified via Supabase Auth, no plaintext leakage |
